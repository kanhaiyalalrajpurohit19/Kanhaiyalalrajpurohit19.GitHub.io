...
function openWhatsApp(){
  window.open("https://wa.me/919460574256?text=✨welcome%20to🙏%20Rajpurohit%20marble%20and%20granite%20💫","_blank");
}

function sendMessage(e){
  e.preventDefault();
  let text=`Name: ${fname.value} ${lname.value}
...
function showDetails(type,i){
  let details=`<h3>${type} Product ${i}</h3>
  <p>Price: ₹${100+i*50}</p>
  <p>Length: ${5+i} ft</p>
  <p>Width: ${2+i} ft</p>
